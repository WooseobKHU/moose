...
#include "CalculateStiffness.h"
#include "RankTwoTensor.h"
#include "RankFourTensor.h"

registerMooseObject("TensorMechanicsApp", CalculateStiffness);

InputParameters
CalculateStiffness::validParams()
{
...
CalculateStiffness::CalculateStiffness(const InputParameters & parameters)
...
void
CalculateStiffness::computeQpProperties()
{
